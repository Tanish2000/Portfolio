    ...
    return (
        <Container >
            ...
            <Row>
                ...
                <p className="text-justify text-white mt-3 p-2 lead" style={{fontSize : '22px'}}>Have a look at my <a href="https://github.com/Tanish2000" target="_blank">Github</a> profile , skills or just connect with me on <a href='https://www.linkedin.com/in/tanish-singh-chouhan-a78856193/' target='_blank'>LinkedIn.</a> I am always excited learn new things from like minded people.</p>
            </Row>
        </Container>
    )
}
