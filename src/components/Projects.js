            ...
            <div className="col-12 col-md-4 my-3">
                <Card style={{ width: '18rem', background: `black`, boxShadow: 'inset 0 0 10px #21109a' }} className="mx-auto">
                    ...
                    <Card.Body>
                        ...
                        <Card.Text className="text-white text-center py-2">
                            <u>Technology</u> <br /><b> HTML | CSS | JS | Bootstrap</b> <br />
                            A place where you can track the progress of Covid vaccinations acroos the globe. You can also check the current scenario of COVID in India.
                        </Card.Text>
                        <div className="d-flex justify-content-center">
